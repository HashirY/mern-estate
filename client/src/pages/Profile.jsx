...
const Profile = () => {
  ...
  const [filePrecentage, setFilePercentage] = useState(0);
  ...
  // uploading the image using firebase storage
  //   rules_version = '2';
  ...
  const handleFileUpload = (file) => {
    ...
    // to see the percentage of uploads
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className="text-red-700 mt-5">
        {showListingsError ? "Errow showing listings" : ""}
      </p>
