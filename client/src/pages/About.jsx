  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Hashir Estate is a leading real estate agency that specializes in
      ...
      <p className="mb-4 text-slate-700">
        ...
        providing expert advice, personalized servlce, and a deep understanding
        of the local market. Whether you are looking to buy, sell, or rent a
        property, we are here to help you every step of the way.
      </p>
      <p className="mb-4 text-slate-700">
        Our team ot agents has a wealth of experience and knowledge in the real
        ...
        should be an exciting and rewarding experience. and we are dedicatedto
